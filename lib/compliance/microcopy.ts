...
export const MICROCOPY = Object.freeze({
  ...
  nothingPostedWithoutYou: "Nothing is posted without you. You choose the words and you press Post on Google.",
  serviceSourceWebsite: "These are the services listed on this business's website.",
  serviceSourceGoogle: "These are the services listed on this business's Google Business Profile.",
