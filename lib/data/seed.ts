...
export function buildSeed(): FoundlyData {
  ...
  const data: FoundlyData = {
    ...
    agency: {
      ...
      clients: [
        { locationId: "loc_harbourview", name: "Harbourview Physiotherapy", city: "Toronto", growthScore: 78, rating: 4.7, newReviews30d: 9, needsReply: 3, plan: "growth", lastReportSent: daysAgo(6), status: "healthy" },
        { locationId: "loc_maple", name: "Maple Dental Studio", city: "Mississauga", growthScore: 71, rating: 4.6, newReviews30d: 6, needsReply: 5, plan: "pro", lastReportSent: daysAgo(6), status: "attention" },
        { locationId: "loc_summit", name: "Summit HVAC & Heating", city: "Brampton", growthScore: 58, rating: 4.3, newReviews30d: 2, needsReply: 8, plan: "growth", lastReportSent: daysAgo(34), status: "at_risk" },
        { locationId: "loc_bright", name: "Brightside Chiropractic", city: "Toronto", growthScore: 82, rating: 4.8, newReviews30d: 11, needsReply: 1, plan: "pro", lastReportSent: daysAgo(6), status: "healthy" },
      ],
    },
    platform: {
      tenants: [
