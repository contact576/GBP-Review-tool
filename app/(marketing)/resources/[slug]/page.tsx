...
import { Container, Eyebrow, CtaBand, heroSecondaryBtn } from "../../_components/primitives";
  ...
  return (
    <div>
          ...
          <div className="mt-10 space-y-10">
            {article.sections.map((section) => (
              <section key={section.heading}>
                <h2 className="text-[22px] font-bold tracking-tight text-ink">{section.heading}</h2>
      ...
      <CtaBand
        ...
        lede="A free Local Growth Score — reviews, profile, and how you compare to the block, in about 30 seconds."
        actions={
          <>
            <LinkButton href="/score" size="lg" icon="sparkles">Get my free Growth Score</LinkButton>
            <LinkButton href="/resources" size="lg" variant="secondary" className={heroSecondaryBtn}>
              More guides
            </LinkButton>
          </>
        }
